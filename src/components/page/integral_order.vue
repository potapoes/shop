        ...
        <div class="order-wrap">
            <div class="order-list" v-for="(item,index) in $store.state.order" :key="item.id">
                <div class="hd clearfix">
                    ...
                    <span class="status fr" v-if="item.order_status == -1">取消订单</span>
                    <span class="status fr" v-else-if="item.order_status == 0">未支付</span>
                    <span class="status fr" v-else-if="item.order_status == 1">已支付</span>
                    <span class="status fr" v-else-if="item.order_status == 2">发货中</span>
                    <span class="status fr" v-else-if="item.order_status == 3">已发货</span>
                    <span class="status fr" v-else-if="item.order_status == 4">已收货</span>
                    <span class="status fr" v-else-if="item.order_status == 5">退货审核中</span>
                    <span class="status fr" v-else-if="item.order_status == 6">审核失败</span>
                    <span class="status fr" v-else-if="item.order_status == 7">审核成功</span>
                    <span class="status fr" v-else-if="item.order_status == 8">退款中</span>
                    <span class="status fr" v-else>退款成功</span>
                </div>
                ...
                <div class="commod clearfix">
                    ...
                    <span class="fl actual">积分兑换&nbsp;:&nbsp;<span>-{{item.price_sum}}</span></span>
