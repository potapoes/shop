<template>
  <div>
    ...
    <con-header :text ="text[0]"></con-header>
     <ul class="per-center">
         <li>
            <span> 账户开户名:</span><input type="text" placeholder="请输入银行开户名...">
        </li>
        <li>
            <span> 公司银行账户:</span><input type="text" placeholder="请输入公司银行账户...">
        </li>
        <li>
    ...
    <con-header :text ="text[2]"></con-header>
     <ul class="per-center">
         <li>
            <span> 税务登记证号:</span><input type="text" placeholder="请输入税务登记证号...">
        </li>
    </ul>
    <div class="idPhotos">
        <h4>税务登记证号电子版：</h4>
...
export default {
  ...
  methods:{
       nextinfor:function(){
      this.$router.push({name:"checkComBusinessInfor"})
    }
  },
  components:{
    topHeader,
