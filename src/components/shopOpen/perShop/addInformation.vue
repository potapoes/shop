<template>
  <div>
    ...
    <con-header :text ="text[0]"></con-header>
     <ul class="per-center">
       <li>
        <span> 店铺名称：</span><input type="text" placeholder="请输入店铺名称...">
       </li>
       <li>
         <a href="javascript:;">
            <span> 所在地区:</span><img class="rightImg" src="../../../assets/images/right-icon.png" alt="">
         </a>
       </li>
        <li>
        ...
        <li>
        <span> 联系人手机:</span><input type="text" placeholder="请输入手机号码...">
       </li>
    </ul>
    <con-header :text ="text[1]"></con-header>
      <ul class="per-center">
       ...
       <li>
        <span> 身份证号码:</span><input type="text" placeholder="请输入身份证号码...">
       </li>
    </ul>
...
export default {
  ...
  methods: {
    nextinfor:function(){
      this.$router.push({name:"checkProIdInfor"})
    }
  }
}
</script>
